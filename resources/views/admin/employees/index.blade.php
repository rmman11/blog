...
@section('pageTitle', 'Employees List')
@section('content')
...
{{-- view employee modal end --}}
        ...
        <div class="card shadow">
          ...
          <div class="card-body" id="show_all_employees">
            <h1 class="text-center text-secondary">Loading...</h1>
          </div>
        </div>
      </div>
  ...
  <script>
    $(function() {
      ...
      $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          url: '{{ route('admin.employess.store') }}',
          method: 'post',
          data: fd,
          cache: false,
          contentType: false,
      ...
      // AJAX request
      var url = "{{ route('admin.employees.show',['id']) }}";
      ...
      $(document).on('click', '.editIcon', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#avatar").html(
              `<img src="/app/public/avatars/${response.avatar}" width="100" class="img-fluid img-thumbnail">`);
      ...
      function fetchAllEmployees() {
        $.ajax({
          url: '{{ route('admin.employees.fetchAll') }}',
          method: 'get',
          success: function(response) {
